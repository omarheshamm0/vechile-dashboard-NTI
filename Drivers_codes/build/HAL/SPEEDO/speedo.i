...
{
    if ((pData == ((void *)0)) || (pCfg == ((void *)0)) || (pCfg->pulsesPerRev == 0))
    {
        return;
    }
    ...
    uint16_t pulses = 
# 30 "HAL/SPEEDO/speedo.c" 3
                     (*(volatile uint16_t *)((0x2C) + 0x20))
# 30 "HAL/SPEEDO/speedo.c"
                          ;
    
# 31 "HAL/SPEEDO/speedo.c" 3
   (*(volatile uint16_t *)((0x2C) + 0x20)) 
# 31 "HAL/SPEEDO/speedo.c"
         = 0;
